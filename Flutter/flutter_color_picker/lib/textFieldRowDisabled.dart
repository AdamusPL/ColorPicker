...
class TextFieldRowDisabled extends StatefulWidget {
  ...
  @override
  _TextFieldRowDisabledState createState() => _TextFieldRowDisabledState();
}

class _TextFieldRowDisabledState extends State<TextFieldRowDisabled> {
